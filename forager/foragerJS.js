...
function imageItems() {
	$("#base div:contains('flask')").css({
		"background-image" : "url(flask.png)"
	});
	$("#base div:contains('firepit')").css({
		"background-image" : "url(firepit.png)"
	});
	...
	$("#items div:contains('twigs'), #mine li:contains('twigs')").css({
		"background-image" : "url(twigs.png)"
	});
